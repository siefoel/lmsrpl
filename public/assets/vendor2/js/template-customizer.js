        ...
        function t(e) {
          ...
          if (
            ...
            if (
              ...
              (this.settings.defaultMenuCollapsed = void 0 !== c ? c : k),
              (this.settings.defaultMenuFlipped = void 0 !== u ? u : F),
                  ...
                  if (i) {
                    ...
                    this._loadStylesheets(
                      g(
                        {},
                        a,
                        document.querySelector(".template-customizer-theme-css")
                      ),
                      s || function () {}
                    ),
                      e &&
              ...
              value: function (e) {
                ...
                if (e !== this.settings.lang || i) {
                  ...
                  for (
                    ...
                    ).textContent = o[c] || this._getThemeByName(c).title;
                  }
              ...
              value: function () {
                ...
                (t =
                  ...
                  (this.settings.layoutMenuFlipped =
                    "" !== a ? "true" === a : this.settings.defaultMenuFlipped),
                  (this.settings.showDropdownOnHover =
                    "" !== o
                      ? "true" === o
                      : this.settings.defaultShowDropdownOnHover),
                  (this.settings.layoutNavbarFixed =
                    "" !== n ? "true" === n : this.settings.defaultNavbarFixed),
                  (this.settings.layoutFooterFixed =
                    "" !== l ? "true" === l : this.settings.defaultFooterFixed),
              ...
              value: function () {
                ...
                if (this._hasControls("themes")) {
                  ...
                  this.settings.availableThemes.forEach(function (e) {
                    ...
                    m
                      .querySelector(
                        'input[value="'.concat(this.settings.theme.name, '"]')
                      )
                ...
                if (
                  ...
                  if (this._hasControls("layoutType")) {
                    (this._controls.layoutType = b.querySelector(
                      ...
                      this._controls.layoutType
                        .querySelector(
                          'input[value="'.concat(this.settings.layoutType, '"]')
                        )
                        .setAttribute("checked", "checked");
                    var _ = function (e) {
                  ...
                  if (
                    ...
                    (this._controls.layoutNavbarFixed =
                      this._controls.layoutNavbarFixedW.querySelector("input")),
                      this.settings.layoutNavbarFixed &&
                        this._controls.layoutNavbarFixed.setAttribute(
                          "checked",
                          "checked"
                  ...
                  if (
                    ...
                    (this._controls.layoutFooterFixed =
                      this._controls.layoutFooterFixedW.querySelector("input")),
                      this.settings.layoutFooterFixed &&
                        this._controls.layoutFooterFixed.setAttribute(
                          "checked",
                          "checked"
              ...
              value: function () {
                if (this._hasControls("style")) {
                  ...
                  this._insertStylesheet(
                    ...
                    ("light" === t ? ["dark-style"] : ["light-style"]).forEach(
                      function (t) {
